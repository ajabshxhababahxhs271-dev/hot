...
const sources = [
  ...
  { name:'Solidot',slug:'solidot',type:'rss',region:'china',defaultCategory:'tech',url:'https://www.solidot.org/index.rss',fetchIntervalMinutes:20,enabled:true },
  { name:'OSChina 资讯',slug:'oschina-news',type:'rss',region:'china',defaultCategory:'tech',url:'https://www.oschina.net/news/rss',fetchIntervalMinutes:20,enabled:true },
  { name:'雷峰网',slug:'leiphone',type:'rss',region:'china',defaultCategory:'ai',url:'https://www.leiphone.com/feed',fetchIntervalMinutes:20,enabled:true },
  ...
  { name:'VentureBeat AI',slug:'venturebeat-ai',type:'rss',region:'global',defaultCategory:'ai',url:'https://venturebeat.com/category/ai/feed/',fetchIntervalMinutes:30,enabled:true },
  { name:'The Decoder',slug:'the-decoder',type:'rss',region:'global',defaultCategory:'ai',url:'https://the-decoder.com/feed/',fetchIntervalMinutes:30,enabled:true },
  { name:'Google AI Blog',slug:'google-ai-blog',type:'rss',region:'global',defaultCategory:'ai',url:'https://blog.google/technology/ai/rss/',fetchIntervalMinutes:30,enabled:true },
  { name:'NVIDIA AI Blog',slug:'nvidia-ai-blog',type:'rss',region:'global',defaultCategory:'ai',url:'https://blogs.nvidia.com/blog/category/deep-learning/feed/',fetchIntervalMinutes:30,enabled:true },
  ...
  { name:'NPR News',slug:'npr-news',type:'rss',region:'global',defaultCategory:'politics',url:'https://feeds.npr.org/1001/rss.xml',fetchIntervalMinutes:30,enabled:true },
  { name:'Engadget',slug:'engadget',type:'rss',region:'global',defaultCategory:'tech',url:'https://www.engadget.com/rss.xml',fetchIntervalMinutes:30,enabled:true },
  { name:'NASA News',slug:'nasa-news',type:'rss',region:'global',defaultCategory:'research',url:'https://www.nasa.gov/news-release/feed/',fetchIntervalMinutes:60,enabled:true },
